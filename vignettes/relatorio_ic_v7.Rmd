...
#  "_(QC5) Teste de Consistência Espacial_",
  "_(QC6) Teste de Regressão Esapcial_")
...
$x'$ é a estimativa não ponderada, obtida através do erro padrão de estimativa (s);
$s'$ é erro padrão ponderado da estimativa;
$f$ é uma constante de ajuste, cujo valor é 3.
...
## <font size="3.5"> __3.6 Regressão Espacial (QC6)__

```{r, eval=FALSE, message=FALSE, echo=FALSE}
text.suspect(
  test_name = "Regressão Espacial",
  test_type = "daily",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc6a-summary-tavg-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(a)__ A aplicação do teste de Regressão Espacial 'a' nas 80 EMAs selecionadas gerou 70 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.0856% (≈ 3 dias), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A842 – Nova Fátima (PR), com 0.365% (12 dias) ([Tabela 15](#Tabela 15)).
</p>

<font size="2">
<a id = "Tabela 04"> </a>
__Tabela 15__ – EMAs com maior número de dados considerados suspeitos no teste QC2a em ordem decrescente.

```{r, echo=FALSE}
t14 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc6a-summary-tavg-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "days",
#  RETURN = "table")
  RETURN = "dt")
